...
class CustomerController extends Controller
{
    public function CustomerCreate(Request $request)
    {
        ...
        $formattedNumber = str_pad($is_numbers, 4, '0', STR_PAD_LEFT); // Add 4 as the length of the final string
        $CustNumber = "CUST/" . $formattedNumber;
    ...
    public function CustomerCreateAction(Request $request)
    {
        ...
        $request->validate([
            ...
            $customer->cus_id =  $request->cust_id;
