...
class LeaveAllocationController extends Controller
{
    public function get_leave_allocation()
    {
        ...
        return response()->json(['success' => 1, 'data' => LeaveAllocationResource::collection($leaveAllocation)], 200, [], JSON_NUMERIC_CHECK);
    }
    ...
    public function save_leave_allocation(Request $request)
    {
        ...
        return response()->json(['success' => 1, 'data' => new LeaveAllocationResource($leaveAllocation)], 200, [], JSON_NUMERIC_CHECK);
    }
