                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <nav role="navigation" class="navbar navbar-expand-sm navbar-default navbar-light mainmenu">
                                <img src="{{ asset('public/assets/images/brand/utkarsh-white-logo.png') }}" alt="logo" class="sitelogo_design" id="mobile_logo" style="color: white;">
                                ...
                                <div id="navbarCollapse" class="collapse navbar-collapse topheader_backarea">
                                    <img src="{{ asset('public/assets/images/brand/utkarsh-white-logo.png') }}" alt="logo" class="sitelogo_design" id="desktop_logo" style="color: white;">
                                    <ul id="fresponsive" class="nav navbar-nav dropdown">
                                        <li>
                                            <a href="{{ route('dashboard') }}">
                                                {{--  <i class="fas fa-home topheadermenu_icon"></i>  --}}
                                                <img src="{{ asset('public/assets/images/brand/dashboard (2).png') }}" alt="img" >
                                                Dashboard
                                            </a>
                                        </li>
                                        ...
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle">
                                                ...
                                                <img src="{{ asset('public/assets/images/brand/user (4).png') }}" alt="img">
                                                Manage User
                                            ...
                                            <ul class=" dropdown-menu">
                                                ...
                                                <li>
                                                    <a href="{{ route('user-list') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;User List</a>
                                                </li>
                                                @endif
                                                @if (auth()->user()->can('User Add'))
                                                <li>
                                                    <a href="{{ route('UserCreate') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;Add New User</a>
                                                </li>
                                                @endif
                                        ...
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle">
                                                ...
                                                <img src="{{ asset('public/assets/images/brand/settings (2).png') }}" alt="img">
                                                Setup
                                                <span class="caret"></span>
                                            </a>
                                            <ul class=" dropdown-menu">
                                                ...
                                                <li>
                                                    <a href="{{ route('general_setting_details') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;General Setting</a>
                                                </li>
                                                @endif
                                                <!-- <li>
                                                ...
                                                <li>
                                                    <a href="{{ route('Customer-list') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;Customer</a>
                                                </li>
                                                @endif
                                                @if (auth()->user()->can('Is Master'))
                                                <li>
                                                    <a href="{{ route('is-master-list') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;Is Master</a>
                                                </li>
                                                @endif
                                                @if (auth()->user()->can('Size Master'))
                                                <li>
                                                    <a href="{{ route('size-master-list') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;Size Master</a>
                                                </li>
                                                @endif
                                                @if (auth()->user()->can('Thickness Master'))
                                                <li>
                                                    <a href="{{ route('ThicknessMasterList') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;Thickness Master</a>
                                                </li>
                                                @endif
                                                @if (auth()->user()->can('Grade Master'))
                                                <li>
                                                    <a href="{{ route('GradeMasterList') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;Grade Master</a>
                                                </li>
                                                @endif
                                                @if (auth()->user()->can('PoDo Master'))
                                                <li>
                                                    <a href="{{ route('PoDoMasterList') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;Po/Do Master</a>
                                                </li>
                                                @endif
                                                @if (auth()->user()->can('MaxMinLimit'))
                                                <li>
                                                    <a href="{{ route('MaxMinLimitList') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;Max Min Limit</a>
                                                </li>
                                                @endif
                                                @if (auth()->user()->can('Coil Master'))
                                                <li>
                                                    <a href="{{ route('CoilMasterList') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;Coil Master</a>
                                                </li>
                                                @endif
                                                @if (auth()->user()->can('Batch Entry'))
                                                <li>
                                                    <a href="{{ route('BatchList') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;Batch</a>
                                                </li>
                                                @endif
                                                @if (auth()->user()->can('Tc Master'))
                                                <li>
                                                    <a href="{{ route('TcMasterList') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;Tc Master</a>
                                                </li>
                                                @endif
                                            </ul>
                                        </li>
                                        ...
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle">
                                                {{--  <i class="fas fa-user topheadermenu_icon"></i>  --}}
                                                <img src="{{ asset('public/assets/images/brand/project-manager.png') }}" alt="img">
                                                Role & Permission
                                                <span class="caret"></span>
                                            </a>
                                            <ul class=" dropdown-menu">
                                                @can('view role')
                                                <li>
                                                    <a href="{{ route('roleList') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;Role</a>
                                                </li>
                                                @endcan

                                                @can('view permission')
                                                <li>
                                                    <a href="{{ route('PermissionList') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;Permission</a>
                                                </li>
                                                @endcan
                                        ...
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle">
                                                ...
                                                <img src="{{ asset('public/assets/images/brand/file.png') }}" alt="img">
                                                Reports
                                                <span class="caret"></span>
                                            </a>
                                            <ul class=" dropdown-menu">
                                                @if (auth()->user()->can('Batch Report'))
                                                <li>
                                                    <a href="{{ route('BatchReport') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;Batch Report</a>
                                                </li>
                                                @endif
                                                @if (auth()->user()->can('Tc Report'))
                                                <li>
                                                    <a href="{{ route('TcReport') }}" class="navdropdwn_menuztext"><i class="fas fa-caret-right"></i>&nbsp;&nbsp;Tc Report</a>
                                                </li>
                                                @endif
                                ...
                                <div class="userprofile_icon" id="usertop_area">
                                    <img class="menwork_design" src="{{ asset('public/assets/images/brand/add-friend.png') }}" alt="img">
                                    <div class="userdetails_area" id="userdown_area">
                                        ...
                                        <ul class="useranother_listarea">
                                            <li>
                                                <a href="{{ route('user-profile') }}/{{ base64_encode(Auth::id()) }}">
