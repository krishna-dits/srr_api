                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="indentification_no" id="indentification_no" value="{{ old('indentification_no') }}" required placeholder="Enter Indentification No" />
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="hit_no" id="hit_no" value="{{ old('hit_no') }}" required placeholder="Enter Hit No" />
                                    @error('hit_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="carbon" id="carbon" value="{{ old('carbon') }}" required placeholder="Enter Carbon" />
                                    @error('carbon')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="mangnese" id="mangnese" value="{{ old('mangnese') }}" required placeholder="Enter Mangnese" />
                                    @error('mangnese')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="Phosphorus" id="Phosphorus" value="{{ old('Phosphorus') }}" required placeholder="Enter Phosphorus" />
                                    @error('Phosphorus')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="sulphur" id="sulphur" value="{{ old('sulphur') }}" required placeholder="Enter Sulphur" />
                                    @error('sulphur')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="silicon" id="silicon" value="{{ old('silicon') }}" required placeholder="Enter Silicon" />
                                    @error('silicon')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="carbon_equivalent" id="carbon_equivalent" value="{{ old('carbon_equivalent') }}" required placeholder="Enter Carbon Equivalent" />
