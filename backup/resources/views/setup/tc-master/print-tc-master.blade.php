...
<html>
   ...
   <body>
      ...
      <div style="padding: 0px 7px 0px 7px; ">
         ...
         <?php
          ...
          <table style="width: 100%;margin-top:-0.5%;">
            <p style="padding-left: 86%; "> <span style="color: #000; font-size: 11px;">IS: {{$numericValue}} : {{$year->year}}</span><br>
               <img src="{{asset('public')}}/printasset/isi.png" style="width: 25px;margin-top:6px;margin-left:45%;">  <img src="{{asset('public')}}/printasset/boxdesign1.jpg" style="width: 20px;margin-top:6px; "><br> <span style="color: #000; font-size: 11px;">CM/L:5085766</span>
            </p>
         </table>
         <table  width="100%" style="width:96%;margin-right:-2%;margin-top: -1%; ">
            <tr>
               ...
               <th style="width: 0%; text-align: left;">
                  <img src="{{asset('public')}}/printasset/An ISO 9001 2015 Company (3).png" style="width: 127px; margin-left: 5%;">
               </th>
         ...
         <hr style="border-top:1px solid #6cbc4f; width:79%; margin-top: -22px;margin-bottom:20px;margin-left:17%; ">
         <table style="width:95%; margin: 25px 0px 0px 28px !important;border: 1px solid #899499;border-collapse: collapse; background-color:#6cbc4f;margin-top:3px; ">
            ...
            <tr >
               <th
                  ...
                  <span  style="width:64%;display:inline-block;text-transform:uppercase;line-height:normal;text-indent:15px;font-size:12px;font-family:'Font Awesome 5 Free';font-style:normal;color:#000;font-weight:600;border-bottom:1px dashed #000;text-transform:uppercase;margin-bottom: 0px; text-align: justify;"> &nbsp;&nbsp;{{ $tc_master->company }}
                  </span>
               </th>
               <th
                  >
                  ...
                  <span  style="width:75%;display:inline-block;text-transform:uppercase;line-height:normal;text-indent:15px;font-size:12px;font-family:'Font Awesome 5 Free';font-style:normal;color:#000;font-weight:600;border-bottom:1px dashed #000;text-transform:uppercase;margin-bottom: 0px; text-align: justify;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $tc_master->tc_id }}
                  </span>
               </th>
               <th
                  >
...
TESTING. Contained in the BIS certifications Marks L/C No. CM/L<b>{{ $tc_master->cml_no}}</b> are as indicated in your order (Please refer to <b>IS {{$numericValue}} : {{$year->year}} </b>for details of specification requirements)</p>
         ...
         <table cellspacing="0" border="1" width="100%" style="text-align:center;width:95%;margin: 0 auto;margin-top: px;background-image:url('{{asset('public')}}/printasset/bg.jpg');background-repeat: no-repeat;background-position: center center;">
            ...
            <tr>
               ...
               <th style="font-size: 10px;width: 80px;">Mass of Zink<br>gm/m<sup>2</sup></th>
               <th style="font-size: 10px;width: 80px;">Uniformity test<br>5x1 min</th>
        ...
        <tr>
            ...
            <td style="font-size: 11px; width: 100px;">{{ @$list->description }}</td>
            ...
            <td style="font-size: 11px;">{{ @$list->dip_test }}</td>
            <td style="font-size: 11px;">{{ @$tc_master->coating_thikness }}</td>
            <td style="font-size: 11px;">{{ @$list->adh_test }}</td>
            <td style="font-size: 11px;">{{ @$list->free_bore }}</td>
...
threads conforming to IS 554 : 1999. <b>Our Products have been manufactured from IS marked HR Coil only<b></span></td>
