                            ...
                            <div class="form-group col-md-12" style="border-top: 1px solid #ede8e8;">
                                <table class="table card-table table-vcenter text-nowrap" id="subhendu">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($edit_tc_detail as $index => $edit_tc_details)
                                        <tr>

                                            <td>
                                                <input type="text" class="form-control" name="sl_no[]" id="sl_no{{$index + 1}}" value="{{$edit_tc_details->sl_no}}" />
                                            </td>

                                            <td>
                                                <input type="text" class="form-control" name="c_per[]" id="c_per{{$index + 1}}" value="{{$edit_tc_details->c_per}}" />
                                            </td>

                                            <td>
                                                <input type="text" class="form-control" name="mn_per[]" id="mn_per{{$index + 1}}" value="{{$edit_tc_details->mn_per}}" />
                                            </td>

                                            <td>
                                                <input type="text" class="form-control" name="ph_per[]" id="ph_per{{$index + 1}}" value="{{$edit_tc_details->p_per}}" />
                                            </td>

                                            <td>
                                                <input type="text" class="form-control" name="su_per[]" id="su_per{{$index + 1}}" value="{{$edit_tc_details->s_per}}" />
                                            </td>

                                            <td>
                                                <input type="text" class="form-control" name="si_per[]" id="si_per{{$index + 1}}" value="{{$edit_tc_details->si_per}}" />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="ce_per[]" id="ce_per{{$index + 1}}" value="{{$edit_tc_details->ce_per}}" />
                                            </td>

                                            <td>
                                                <input type="text" class="form-control" name="uts_per[]" id="uts_per{{$index + 1}}" value="{{$edit_tc_details->uts}}" />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="yst_per[]" id="yst_per{{$index + 1}}" value="{{$edit_tc_details->yst}}" />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="elgn_per[]" id="elgn_per{{$index + 1}}" value="{{$edit_tc_details->elgn}}" />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="flt[]" id="flt{{$index + 1}}" value="{{$edit_tc_details->flt_test}}" />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="bend[]" id="bend{{$index + 1}}" value="{{$edit_tc_details->bend_test}}" />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="drift[]" id="drift{{$index + 1}}" value="{{$edit_tc_details->drift_expn}}" />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="mass[]" id="mass{{$index + 1}}" value="{{$edit_tc_details->massof_zn}}" />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="dip_test[]" id="dip_test{{$index + 1}}" value="{{$edit_tc_details->dip_test}}" />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="adh[]" id="adh{{$index + 1}}" value="{{$edit_tc_details->free_bore}}" />
                                            </td>
                                            <input type="hidden" class="form-control" name="addition_test[]" id="addition_test{{$index + 1}}" value="{{$edit_tc_details->adh_test}}" />
                                            <td>

                                                <select class="form-control select2-show-search select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="ends[]" id="ends{{$index + 1}}">
                                                    <option value="">Select</option>
                                                    @foreach (Config::get('static.Ends') as $lang => $end)
                                                    <option value="{{ $end }}" {{  $end == $edit_tc_details->ends ? 'selected' : ""}}> {{ $end }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            </td>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="remarks[]" id="remarks{{$index + 1}}" value="Satisfactory" />
                                            </td>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response, function(key, value) {
                    let sel = '';
                    // alert(dataArray[key].batch_size);
                    if(value.id == (dataArray[key].batch_size)){
                        sel = 'selected';
                    }
                    else{
                        sel = '';
    ...
    function getIsValues(IsMaster, index) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                adh_Select.val(response.is_values.free_board_test);
