                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="is_size" id="is_size" required placeholder="Enter Is Size" value="{{$editSizeMaster->is_size}}" onchange="getDesire()"/>
                                    @error('is_size')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="is_size1" id="is_size1" value="{{('NA')}}" required placeholder="Enter Is Size 1" value="{{$editSizeMaster->is_size1}}" />
                                    @error('is_size1')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="desier_size" id="desier_size" required placeholder="Enter Desier Size" value="{{$editSizeMaster->desier_size}}" />
                                    @error('desier_size')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="desier" id="desier" required value="{{$editSizeMaster->desier}}" />
                                    @error('desier')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="bend" class="form-control select2-show-search" id="bend" required>
                                        ...
                                        <option value="{{ $ysts }}" {{ $item->is_name == $editSizeMaster->bend ? 'selected' : ""}}> {{ $ysts }}
                                        </option>
                                        @endforeach
                                    </select>
                                    @error('bend')
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="flattening" class="form-control select2-show-search" id="flattening" required>
                                        <option value="" for="flattening">Select</option>
                                        @foreach (Config::get('static.Drift') as $lang => $ysts)
                                        <option value="{{ $ysts }}" {{ $item->is_name == $editSizeMaster->flattening ? 'selected' : ""}}> {{ $ysts }}
                                        </option>
                                        @endforeach
                                    </select>
                                    @error('flattening')
