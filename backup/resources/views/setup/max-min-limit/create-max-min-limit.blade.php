                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="c_max" id="c_max" value="{{ old('c_max') }}" required placeholder="Enter c_max" />
                                @error('c_max')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="mn_max" id="mn_max" value="{{ old('mn_max') }}" required placeholder="Enter mn_max" />
                                @error('mn_max')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="ph_max" id="ph_max" value="{{ old('ph_max') }}" required placeholder="Enter ph_max" />
                                @error('ph_max')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="su_max" id="su_max" value="{{ old('su_max') }}" required placeholder="Enter Su Max" />
                                @error('su_max')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="si_max" id="si_max" value="{{ old('si_max') }}" required placeholder="Enter Su Max" />
                                @error('si_max')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="ce_max" id="ce_max" value="{{ old('ce_max') }}" required placeholder="Enter Su Max" />
                                @error('ce_max')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="yst_min" id="yst_min" value="{{ old('yst_min') }}" required placeholder="Enter Yst Min" />
                                @error('yst_min')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="uts" id="uts" value="{{ old('uts') }}" required placeholder="Enter Uts" />
                                @error('uts')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="elgn" id="elgn" value="{{ old('elgn') }}" required placeholder="Enter Elgn" />
                                @error('elgn')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
