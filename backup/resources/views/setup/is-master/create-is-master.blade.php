                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control @error('is_name') is-invalid
                                        @enderror" name="is_name" placeholder="Is Name" value="{{$IsName}}" readonly>
                                    @error('is_name')
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="year" id="year" value="{{ old('year') }}" required placeholder="Enter Year" />
                                    @error('year')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="cml_no" id="cml_no" value="{{ old('cml_no') }}" required placeholder="Enter cml_no" />
                                    @error('cml_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="hp" id="hp" value="{{ old('hp') }}" required placeholder="Enter hp" />
                                    @error('hp')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
