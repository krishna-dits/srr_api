							...
							<div class="row align-items-center">
								<div class="col-3">
									<div class="item-icon ">
                                        ...
                                        <img src="{{ asset('public/assets/images/brand/customer-satisfaction (2).png') }}" alt="img">
									</div>
								</div>
								<div class="col-9">
									<div class="item-content">
										<div class="item-title">Total Customer</div>
										<div class="item-number"><span class="counter">{{@$all_customers}}</span></div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row align-items-center">
								<div class="col-3">
									<div class="item-icon bg-light-green">
										{{--  <i class="fas fa-users sicon_design"></i>  --}}
                                        <img src="{{ asset('public/assets/images/brand/number-blocks.png') }}" alt="img">
									</div>
								</div>
								<div class="col-9">
									<div class="item-content">
							...
							<div class="row align-items-center">
								...
								<div class="col-9">
									<div class="item-content">
										...
										<div class="item-number"><span class="counter">{{@$podo_no}}</span></div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row align-items-center">
								...
								<div class="col-9">
									<div class="item-content">
										...
										<div class="item-number"><span class="counter">{{@$coil_no}}</span></div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row align-items-center">
								...
								<div class="col-9">
									<div class="item-content">
										...
										<div class="item-number"><span class="counter">{{@$batch_no}}</span></div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row align-items-center">
								...
								<div class="col-9">
									<div class="item-content">
										...
										<div class="item-number"><span class="counter">{{@$tc_no}}</span></div>
									</div>
								</div>
							</div>
						</div>
