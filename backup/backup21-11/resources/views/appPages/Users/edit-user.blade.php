                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        @enderror" name="name" placeholder="Name" value="{{$user_details->name}}">
                                        @error('name')
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        @enderror" name="email" placeholder="Email" value="{{$user_details->email}}">
                                        @error('email')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        @enderror" name="phone_no" value="{{$user_details->phone_no}}">
                                        @error('phone_no')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
