                            ...
                            <div class="col-md-12 mt-2 addborder">
                                ...
                                <div class="form-group col-md-1 mb-0">
                                    <div class="form-group newadd">
                                        ...
                                        <input type="text" class="form-control" name="drift[]" id="drift{{$loop->iteration}}" value="{{@$loop->iterationsDetails->drift_exp}}" />
                                    </div>
                                </div>
        ...
        $('select[name^="lot_no"]').on('change', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    hitNoSelect.append('<option value="">Change Hit No</option>');
