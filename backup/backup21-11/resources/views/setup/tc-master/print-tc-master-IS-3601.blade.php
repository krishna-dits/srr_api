   ...
   <body>
      ...
      <div style="padding: 0px 7px 0px 7px; ">
         ...
         <table style="width: 100%; margin-top:5%;">
             <tr>
                <th>
                  <span>IS : 3601  : 2006</span>
                </th>
             </tr>
             <tr>
             <th style="text-align: left;padding-left:4%; padding-top:1%;"><b>Product Name Shown as-  Steel Tube </b> (for Mechanical and General Engineering Purposes)</th> <br></tr>

         </table>
          <table style="width: 100%;">
             <tr>
               <td style="font-size: 13px;padding-left:3%;padding-top:1%;">Test Results table shown as-</td>
             </tr>
         </table>
         <table cellspacing="0" border="1" width="100%" style="text-align:center;width:100%;margin: 0 auto;margin-top: 10px;">
            ...
            <tr>
               ...
               <th style="font-size: 11px; border-bottom: none;">Description
               ...
               <th colspan="7"style="font-size: 11px;">Mechanical property</th>
            ...
            <tr>
               ...
               <th style="border-top: none;font-size: 11px;">Bend</th>
               <th style="border-top: none;font-size: 11px;">Flattening</th>
               <th style="border-top: none;font-size: 11px;">Strip Bend Test</th>
               <th style="border-top: none;font-size: 11px;">Drift Expansion Test</th>



               <th style="font-size: 11px;width: 80px;">Mass of Zn<br>gms/m<sup>2</sup></th>
               <th style="font-size: 11px;width: 130px;">Coating Thickness (µ)
                Avg. of 5 Thickness reading
                </th>
               <th style="font-size: 11px;">Uniformity Test
                (5X1 min)
               </th>
            ...
            <tr>
               ...
               <td style="font-size: 11px;width: 150px;">ERW OD139.7MM <br> 3.0MM WT210 GP PE</td>
            ...
            <table style="width: 100%; margin-top: 1%;padding-left:5%;">
                <tr>
                    <th style="font-size: 15px; text-align:left;">It is certified that Material supplied confirms to standard dimensions tolerances and straightness.</th>
             ...
             <table style="width: 100%; margin-left: 8%;">
                <tr>
                    <ul>
                        <li style="font-size:14px; ">P/E- Square cut end.</li>
