   ...
   <body>
      ...
      <div style="padding: 0px 7px 0px 7px; ">
         ...
         <table style="width: 100%; margin-top:5%;">
             <tr>
                <th>
                  <span>IS : 9295  : 1983</span>
                </th>
             </tr>
             <tr>
             <th style="text-align: left;padding-left:4%; padding-top:1%;"><b>Product Name Shown as-  Black Steel Tube </b> (for Belt Conveyors)</th> <br></tr>
         ...
         <table cellspacing="0" border="1" width="100%" style="text-align:center;width:100%;margin: 0 auto;margin-top: 10px;">
            ...
            <tr>
               ...
               <td style="font-size: 11px;width: 150px;">ERW OD152.4MM<br>5.4MM YSt-240 BP PE</td>
            ...
            <table style="width: 100%; margin-top: 1%;padding-left:5%;">
                <tr>
                    <th style="font-size: 15px; text-align:left;">It is certified that Material supplied confirms to standard dimensions and mass tolerances & Straightness and ovality.</th>
