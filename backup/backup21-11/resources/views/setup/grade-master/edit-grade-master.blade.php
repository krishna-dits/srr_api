...
<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="">
                <form class="row g-3" method="POST" action="{{ route('GradeMasterUpdate') }}">
                    @csrf
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="grade_id" placeholder="Id" value="{{@$editThicknessMaster->grade_id}}" readonly>
                                @error('grade_id')
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="grade" id="grade" value="{{@$editThicknessMaster->grade}}" required placeholder="Enter Grade" />
                                @error('grade')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
