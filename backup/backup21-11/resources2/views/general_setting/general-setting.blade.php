                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" required class="form-control" value="{{$general_details->software_name}}" name="name" placeholder="Name">
                                @error('name')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" required class="form-control" value="{{$general_details->gst_no}}" name="gst_no" placeholder="GST No.">
                                @error('gst_no')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <img id="blah" width="50px" height="30px" src="{{ asset('public/assets/images/brand') }}/{{$general_details->logo}}"  
                                alt="your image" />
                                @error('logo')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
