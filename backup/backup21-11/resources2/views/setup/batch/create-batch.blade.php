...
<div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control select2-show-search select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="coil_no" id="coil_no">
                                        ...
                                        <option value="{{ $item->coil_no }}">{{ $item->indentification_no }}</option>
                                        @endforeach
                                    </select>
                                    @error('coil_no')
                                    <span class="text-danger">{{ $message }}</span>
 ...
 -->
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control select2-show-search select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="size" id="size" onchange="getBatchNo()">
                                        <option value="">Select</option>
                                        @foreach ($size_master as $item)
                                        <option value="{{ $item->desier }}">{{ $item->desier }}</option>
                                        @endforeach
                                    </select>
                                    @error('size')
                                    <span class="text-danger">{{ $message }}</span>
