                        ...
                        <span>{{$i}}</span>
                                ...
                                <div class="form-group col-md-1 mb-0">
                                    <div class="form-group newadd">
                                        ...
                                        <input type="text" class="form-control" name="drift[]" id="drift{{$i}}" value="{{@$IsDetails->drift_exp}}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-2 mb-0">
                                    <div class="form-group newadd1">
                                        <label class="form-label">Hit No<span class="text-danger">*</span></label>
...
<script>
    $(document).ready(function () {
        // Event listener for the 'thickness' dropdown
        $('select[name^="batch_size"]').on('change', function () {
            ...
            // Make an AJAX request to get lot numbers based on selected thickness
            $.ajax({
                url: '{{ route('getLotNos') }}',
                method: 'POST',
                data: {
                ...
                success: function (data) {
                    ...
                    // Add other options based on the received data with the same value and text
...
<script>
    $(document).ready(function () {
        ...
        $('select[name^="lot_no"]').on('change', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    row.find('input[name^="freeboretest"]').val(inputValue);
