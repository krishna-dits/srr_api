   ...
   <body>
      ...
      <div style="padding: 0px 7px 0px 7px; ">
         ...
         <table style="width: 100%; margin-top:5%;">
             <tr>
                <th>
                  <span>IS : 1161  : 2014</span>
                </th>
             </tr>
             <tr>
             <th style="text-align: left;padding-left:4%; padding-top:1%;"><b>Product Name Shown as-  Steel Tube</b> (For Structural Purposes)</th> <br></tr>
         ...
         <table cellspacing="0" border="1" width="100%" style="text-align:center;width:100%;margin: 0 auto;margin-top: 10px;">
            ...
            <tr>
               ...
               <th colspan="5"style="font-size: 11px;">Chemical Composition</th>
               ...
               <th colspan="3"style="font-size: 11px;">Galvanizing Coating Test</th>
            ...
            <tr>
               ...
               <td style="font-size: 11px;width: 150px;">ERW OD168.3MM <br> 5.4MM Fe410 GP BE</td>
            ...
            <tr>
             ...
             <table style="width: 100%; margin-top: 3%;">
                <tr>
                    <th style="font-size: 15px; text-align: left;padding-left: 6%;">It is certified that Material supplied confirms to standard dimensions and mass tolerances.</th>
             ...
             <table style="width: 100%; margin-left: 8%;">
                <tr>
                    <ul>
                        <li style="font-size:14px; ">P/E- Square cut ends.</li>
