   ...
   <body>
      ...
      <div style="padding: 0px 7px 0px 7px; ">
         ...
         <table style="width: 100%; margin-top:5%;">
             ...
             <tr>
             <th style="text-align: left;padding-left:4%;"><b>Product Name Shown as- - Carbon Steel Pipes </b> (For Water Wells)</th> <br></tr>
             <tr><th style="text-align:left; padding-left:35%; ">OR</th></tr>
             <tr>
                <th style="text-align: left; padding-left:23%;">Mild Steel Pipes (For Water Wells)</th>
             </tr>
         </table>
         ...
         <table cellspacing="0" border="1" width="100%" style="text-align:center;width:100%;margin: 0 auto;margin-top: 10px;">
            ...
            <tr>
               ...
               <th style="font-size: 11px; border-bottom: none;">Description<br>
                Type X OD X Thickness x Grade X Surface Condition X Ends
                </th>
               ...
               <th colspan="2"style="font-size: 11px;">Chemical Composition</th>
               <th colspan="3"style="font-size: 11px;">Mechanical property</th>
               <th style="font-size: 11px; border-bottom: none;">Flattering</th>
               <th style="font-size: 11px; border-bottom: none;">Protective Coating</th>
               <th colspan="2"style="font-size: 11px;">Coating Test</th>
            ...
            <tr>
               ...
               <th style="border-top: none;font-size: 11px;"></th>

               <th style="font-size: 11px;">Externally coated with a bituminous solution
                </th>
               <th style="font-size: 11px;width: 110px;">At 0˚ Temp.
                (Shall not be Brittle)

                </th>
                <th style="font-size: 11px;width: 110px;">At 65˚ Temp
                    (Sufficiently hard not to flow on exposure)
                    </th>
          ...
          <tr>
            ...
            <tr>
             ...
             <table style="width: 100%; margin-top: 3%;">
                <tr>
                    <th style="font-size: 15px;">It is certified that each steel tube is NDT/ hydrostatically tested to test pressure of  7 MPa. Also Material supplied confirms to standard </th>

                </tr>
                <tr>
                    <th style="text-align: left;font-size: 15px; padding-left: 7%;">dimensions and mass tolerances & Straightness.</th>
                </tr>
             ...
             <table style="width: 100%; margin-left: 8%;">
                <tr>
                    <ul>
                        ...
                        <li style="font-size:14px; margin-top: 5px;">B/E- An angle of bevelled and root face conform to standard.</li>
