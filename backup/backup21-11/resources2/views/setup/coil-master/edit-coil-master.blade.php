                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="indentification_no" id="indentification_no" value="{{$editCoilMaster->indentification_no}}"  placeholder="Enter Indentification No" />
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="hit_no" id="hit_no" value="{{ $editCoilMaster->hit_no }}"  placeholder="Enter Hit No" />
                                    @error('hit_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="carbon" id="carbon" value="{{$editCoilMaster->carbon}}"  placeholder="Enter Carbon" />
                                    @error('carbon')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="mangnese" id="mangnese" value="{{$editCoilMaster->mangnese}}"  placeholder="Enter Mangnese" />
                                    @error('mangnese')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="Phosphorus" id="Phosphorus" value="{{$editCoilMaster->Phosphorus}}"  placeholder="Enter Phosphorus" />
                                    @error('Phosphorus')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="sulphur" id="sulphur" value="{{$editCoilMaster->sulphur}}"  placeholder="Enter Sulphur" />
                                    @error('sulphur')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="carbon_equivalent" id="carbon_equivalent" value="{{$editCoilMaster->carbon_equivalent}}"  placeholder="Enter Carbon Equivalent" />
