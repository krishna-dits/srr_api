                    ...
                    <form method="POST" action="{{route('apply-leave-application')}}">
                        ...
                        <div class="card-body border-top">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Available Leave Details <span class="text-danger"></span></label>
                                    <table class="table">
                                        <thead>
                                          <tr>
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td>
                                                <span class="badge badge-pill badge-primary">{{$userCasualLeave}}</span>
                                            </td>
                                            <td>
                                                <span class="badge badge-pill badge-primary">{{$userSickLeave}}</span>
                                            </td>
                                            <td>
                                                <span class="badge badge-pill badge-primary">{{$userEarnLeave}}</span>
                                            </td>
                                          </tr>
