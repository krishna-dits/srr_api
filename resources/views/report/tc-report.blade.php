                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-control select2-show-search select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="tc_id">
                                                    ...
                                                    <option value="{{ $item->tc_id }}">{{$item->created_at->format('y') }}{{substr(@$item->cast_details->cus_id, -3)}}{{ substr(str_replace(' ', '', $item->is_no), -2) }}{{substr($item->tc_id, -4)}}</option>
                                                    @endforeach
                                                </select>
                                                @error('tc_id')
                                                <span class="text-danger">{{ $message }}</span>
                        ...
                        <table class="table table-bordered text-nowrap" id="example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->created_at->format('y') }}{{substr(@$item->cast_details->cus_id, -3)}}{{ substr(str_replace(' ', '', $item->is_no), -2) }}{{substr($item->tc_id, -4)}}</td>
                                    ...
                                    <td>{{$item->podo_no}}</td>
                                    <td>{{$item->date3}}</td>
                                    <td><a href="{{route('TcMasterPrint',base64_encode($item->id))}}"><i class="fa fa-print"></i> Print</a></td>
                                </tr>
                                @endforeach
                                @endif
                            </tbody>
