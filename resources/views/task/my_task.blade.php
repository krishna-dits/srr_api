        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ Route::is('my_archive_task') ? 'My Archive Task' : 'My Task' }} </h4>
                </div>
                <!-- ================================ Alert Message===================================== -->
                                        ...
                                        <td>
                                            <div class="card-options">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" style="">
                                                    ...
                                                    @if ($item->archive == '0')
                                                        <a class="dropdown-item"
                                                            href="{{ route('archive_task', ['id' => $item->id, 'status' => '1']) }}"><i
                                                                class="fa fa-archive"></i> Archived</a>
                                                    @else
                                                        <a class="dropdown-item"
                                                            href="{{ route('archive_task', ['id' => $item->id, 'status' => '0']) }}"><i
                                                                class="fa fa-archive"></i> Unarchived</a>
                                                    @endif

                                                    <a class="dropdown-item"
                                                        href="{{ route('create_issue', ['task_id' => $item->id]) }}"><i
                                                            class="fa fa-archive"></i>Raise Issue</a>
