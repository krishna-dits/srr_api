                ...
                <div class="overlay_backdesign">
                    <div class="wrap-login100">
                        <form method="POST" action="{{ route('login') }}">
                            @csrf
                            <div class="loginadd" style="">
                            <span class="login100-form-logo">
                                <img src="{{ asset('public/assets/images/brand/logo.webp') }}" class="logoame">
                            </span>
                             <span class="login100-form-logo">
                                <img src="{{ asset('public/assets/images/brand/devant-logo.jpg') }}" class="logoame">
                            </span>
                        </div>
                    ...
                    <div class="support">
                        <p><span>For Support</span>&nbsp;&nbsp; <span> <i class="fas fa-phone" style="color: green;"></i>&nbsp;&nbsp;(+033) 4065 8041</span>&nbsp;&nbsp; <span>&nbsp;&nbsp; <i class="fas fa-envelope"style="color: green;"></i>&nbsp;&nbsp;info@devantitsolutions.com</span></p>
                    </div>
                </div>
            </div>
        </div>
