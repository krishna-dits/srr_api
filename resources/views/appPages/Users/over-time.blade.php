...
@section('content')
    ...
    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
        <div class="card">
            ...
            <!-- ================================ Alert Message ===================================== -->
            <div class="card-body">
                <form action="{{ route('User-Attendence-extra') }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
            ...
            <form method="post" action="{{ route('add-extra-attendence-for-user') }}">
                @csrf
                ...
                @if (isset($all_designations_user))
                            ...
                            <table class="table table-bordered table-striped text-nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Extra Attendence(in hrs)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        @foreach ($all_designations_user as $user)
                                            <tr>
                                                ...
                                                <td>{{ $user->name }}({{ $user->emp_id }})
                                                    @if ($user->attendence_type != null) <br><span class="badge badge-success">Present !!</span> @endif
                                                </td>
                                                <td>
                                                    <div class="col-md-12 row">
                                                        <div class="col-md-12">
                                                            <input name="extra_duty[{{ @$user->id }}]" class="form-control" value="{{@$user->extra_attendence}}" />
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    <div class="card-body">
                        <div class="col-md-12">
                            <button class="btn btn-primary">Save Extra Attendence</button>
                        </div>
                    </div>
                @endif
            </form>
