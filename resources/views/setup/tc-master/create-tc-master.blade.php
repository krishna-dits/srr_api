    ...
    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">Add Tc Master</div>
            </div>
            <script>
            ...
            <div class="card-body">
                <div class="">
                    <form class="row g-3" method="POST" action="{{ route('TcMasterSave') }}">
                        @csrf
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control @error('tc_id') is-invalid
                                        @enderror" name="tc_id" id="tc_id" placeholder="Is Name" value="{{$TcNumber}}" readonly>
                                    @error('tc_id')
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="invoice_no" id="invoice_no" value="{{ old('invoice_no') }}"  placeholder="Enter Invoice No" />
                                    @error('invoice_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select class="form-control select2-show-search select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="is_no" id="is_no" required onchange="updatePartOptions(this.value)">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="vehicle" id="vehicle" value="{{ old('vehicle') }}"  placeholder="Enter vehicle" />
                                    @error('vehicle')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select class="form-control select2-show-search select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="podo_init" id="podo_init" onchange="GetPODo()">
                                        ...
                                        <option value="{{ $item->init }}">{{ $item->init }}</option>
                                        @endforeach
                                    </select>
                                    @error('podo_init')
                                    <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="PO_value" id="PO_value" value="{{ old('PO_value') }}"  placeholder="Enter value" onchange="GetPODo()" />
                                    @error('value')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="cml_no" id="cml_no" value="{{ old('cml_no') }}"  placeholder="Enter CM/L No" />
                                    @error('cml_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="conform_to_is" id="conform_to_is" value="{{ old('conform_to_is') }}"  placeholder="Enter Conform To Is" />
                                    @error('conform_to_is')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="date" class="form-control" name="date1" id="date1" value="{{ old('date1', \Carbon\Carbon::yesterday()->format('Y-m-d')) }}"  />
                                    @error('date1')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="ndt_hp" id="ndt_hp" value="{{ old('ndt_hp') }}"  placeholder="Enter NDT/HP" />
                                    @error('ndt_hp')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="address1" id="address1" value="{{ old('address1') }}"  placeholder="Enter Address1" />
                                    @error('address1')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="address2" id="address2" value="{{ old('address2') }}"  placeholder="Enter Address2" />
                                    @error('address2')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="tc_no" id="tc_no" value="{{ old('tc_no') }}"  placeholder="Enter tc_no" />
                                    @error('tc_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <!-- <div class="col-md-1">
                                    <label class="form-label">Date <span class="text-danger">*</span></label>
                                    <input type="date" class="form-control" name="date2" id="date2" value="{{ old('date2') ?? now()->toDateString() }}"  />
                                    @error('date2')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div> -->
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="podo_no" id="podo_no" value="{{ old('podo_no') }}"  placeholder="Enter PO/DO No" />
                                    @error('podo_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-1">
                                    <label class="form-label">Date<span class="text-danger">*</span></label>
                                    <input type="date" class="form-control" name="date4" id="date3" value="{{ old('date4') }}"  placeholder="Enter Date" />
                                    @error('date3')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="po_no" id="po_no" value="{{ old('po_no') }}"  placeholder="Enter PO/DO No" />
                                    @error('po_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-1">
                                    <label class="form-label">Date<span class="text-danger">*</span></label>
                                    <input type="date" class="form-control" name="date3" id="date3" value="{{ old('date3') }}"  placeholder="Enter Date" />
                                    @error('date3')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
    ...
    function updatePartOptions(selectedIsNo) {
        ...
        $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#tc_grade').append('<option value="' + value.grade + '">' + value.grade + '</option>');
                });
