                ...
                <table id="example" class="table table-borderless text-nowrap key-buttons">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- <td>{{$item->tc_id}}</td> -->
                            <td>{{$item->created_at->format('y') }}{{substr(@$item->cast_details->cus_id, -3)}}</td>
                            ...
                            <td>
                                <div class="card-options">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" style="">
                                        ...
                                        <a class="dropdown-item" href="{{route('TcMasterAdd_previous',base64_encode($item->id))}}"><i class="fa fa-edit"></i> Edit</a> 
