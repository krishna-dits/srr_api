                ...
                <div class="">
                    <form class="row g-3" method="POST" action="{{ route('TcMasterAdd_previous_update') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="invoice_no" id="invoice_no" value="{{@$TcDetail->invoice_no}}"  placeholder="Enter Invoice No" />
                                    @error('invoice_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select name="type" class="form-control select2-show-search" id="type"  onchange="getPorductName(this.value)">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="is_no" id="is_no" value="{{@$TcDetail->is_no}}"  placeholder="Enter Invoice No" readonly />
                                    @error('is_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-1">
                                    ...
                                    <input type="text" class="form-control" name="tc_grade" id="tc_grade" value="{{@$TcDetail->tc_grade}}"  placeholder="Enter Invoice No" readonly />
                                    @error('tc_grade')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-1">
                                    ...
                                    <input type="text" class="form-control" name="part_no" id="part_no" value="{{@$TcDetail->part_no}}"  placeholder="Enter Invoice No" readonly />
                                    @error('part_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <!-- <div class="col-md-1">
                                    <label class="form-label">Grade<span class="text-danger">*</span></label>
                                    <select class="form-control select2-show-search select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="tc_grade" id="tc_grade">
                                    </select>
                                    @error('tc_grade')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="vehicle" id="vehicle" value="{{@$TcDetail->vehicleno}}"  placeholder="Enter vehicle" />
                                    @error('vehicle')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="product" id="product" value="{{ old('product') }}"  placeholder="Enter Product" />
                                    @error('product')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="podo_value" id="podo_value" value="{{@$TcDetail->podo_value}}" a placeholder="Enter value" onchange="GetPODo()" />
                                    @error('value')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="cml_no" id="cml_no" value="{{@$TcDetail->cml_no}}"  placeholder="Enter CM/L No" />
                                    @error('cml_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="conform_to_is" id="conform_to_is" value="{{@$TcDetail->conformToIs}}"  placeholder="Enter Conform To Is" />
                                    @error('conform_to_is')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="date" class="form-control" name="date1" id="date1" value="{{@$TcDetail->date1}}"  />
                                    @error('date1')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="ndt_hp" id="ndt_hp" value="{{@$TcDetail->hp}}"  placeholder="Enter NDT/HP" />
                                    @error('ndt_hp')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="address1" id="address1" value="{{@$TcDetail->address1}}"  placeholder="Enter Address1" />
                                    @error('address1')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="address2" id="address2" value="{{@$TcDetail->address2}}"  placeholder="Enter Address2" />
                                    @error('address2')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="tc_no" id="tc_no" value="{{@$TcDetail->tc_no}}"  placeholder="Enter tc_no" />
                                    @error('tc_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <!-- <div class="col-md-1">
                                    <label class="form-label">Date <span class="text-danger">*</span></label>
                                    <input type="date" class="form-control" name="date2" id="date2" value="{{@$TcDetail->date2}}"  />
                                    @error('date2')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div> -->
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="podo_no"  value="{{@$TcDetail->podo_no}}"  placeholder="Enter PO/DO No" />
                                    @error('podo_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-1">
                                    <label class="form-label">Date<span class="text-danger">*</span></label>
                                    <input type="date" class="form-control" name="date4" id="date4" value="{{@$TcDetail->date4}}"  placeholder="Enter Date" />
                                    @error('date3')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="po_no" id="po_no" value="{{@$TcDetail->po_no}}"  placeholder="Enter PO/DO No" />
                                    @error('po_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-1">
                                    <label class="form-label">Date<span class="text-danger">*</span></label>
                                    <input type="date" class="form-control" name="date3" id="date3" value="{{@$TcDetail->date3}}"  placeholder="Enter Date" />
                                    @error('date3')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="text-right mt-3 ml-3">
                                ...
                                <a href="{{route('TcMasterEdit',base64_encode($TcDetail->id))}}" class="btn btn-primary"><i class="fa fa-arrow-right"></i>&nbsp;Next</a>
...
<script>
    ...
    function updatePartOptions(selectedIsNo) {
        ...
        $.ajax({
                url: '{{ route("get-grades-on-tc-master") }}', // Use the named route
                type: 'POST',
                data: {is_name: selectedIsNo,
                _token: '{{ csrf_token() }}',
                ...
                success: function (data) {
                    ...
                    // Populate the Grade dropdown with the fetched data
                    $.each(data, function (key, value) {
                    $('#tc_grade').append('<option value="' + value.id + '">' + value.grade + '</option>');
                });
    ...
    // Assuming the "part" dropdown has an id of 'part'
    $('#part').on('change', function () {
        updateConformIs(); // Call the function to update conformIs on part change
    });
    ...
    $.ajax({
        ...
        dataType: 'json',
        success: function (res) {
            updateFields(res); // Call the function to update fields with the response
        }
    });

    // Function to update conformIs and other fields
    function updateFields(res) {
        let year = res.year;
        let selectedPart = $('#part').val(); // Get the selected part value

        if (year != '' && selectedIsNo != '') {
            let conformIs;
            if (selectedPart === 'NA') {
                conformIs = selectedIsNo + ': ' + year; // If part is 'NA'
            } else {
                conformIs = selectedIsNo + '(' + selectedPart + '): ' + year; // If part is selected
            }
    ...
    // Function to update conformIs on part change
    function updateConformIs() {
        $.ajax({
            url: "{{ route('get-coform-is-year') }}",
            type: "post",
            data: {
