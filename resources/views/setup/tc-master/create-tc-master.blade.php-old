                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="invoice_no" id="invoice_no" value="{{ old('invoice_no') }}" required placeholder="Enter Invoice No" />
                                    @error('invoice_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="vehicle" id="vehicle" value="{{ old('vehicle') }}" required placeholder="Enter vehicle" />
                                    @error('vehicle')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="PO_value" id="PO_value" value="{{ old('PO_value') }}" required placeholder="Enter value" onchange="GetPODo()" />
                                    @error('value')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="cml_no" id="cml_no" value="{{ old('cml_no') }}" required placeholder="Enter CM/L No" />
                                    @error('cml_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="conform_to_is" id="conform_to_is" value="{{ old('conform_to_is') }}" required placeholder="Enter Conform To Is" />
                                    @error('conform_to_is')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="date" class="form-control" name="date1" id="date1" value="{{ old('date1', \Carbon\Carbon::yesterday()->format('Y-m-d')) }}" required />
                                    @error('date1')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="ndt_hp" id="ndt_hp" value="{{ old('ndt_hp') }}" required placeholder="Enter NDT/HP" />
                                    @error('ndt_hp')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="address1" id="address1" value="{{ old('address1') }}" required placeholder="Enter Address1" />
                                    @error('address1')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="address2" id="address2" value="{{ old('address2') }}" required placeholder="Enter Address2" />
                                    @error('address2')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="tc_no" id="tc_no" value="{{ old('tc_no') }}" required placeholder="Enter tc_no" />
                                    @error('tc_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-1">
                                    <label class="form-label">Date <span class="text-danger">*</span></label>
                                    <input type="date" class="form-control" name="date2" id="date2" value="{{ old('date2') ?? now()->toDateString() }}" required />
                                    @error('date2')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="podo_no" id="podo_no" value="{{ old('podo_no') }}" required placeholder="Enter PO/DO No" />
                                    @error('podo_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="po_no" id="po_no" value="{{ old('po_no') }}" required placeholder="Enter PO/DO No" />
                                    @error('po_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-1">
                                    <label class="form-label">Date<span class="text-danger">*</span></label>
                                    <input type="date" class="form-control" name="date3" id="date3" value="{{ old('date3') }}" required placeholder="Enter Date" />
                                    @error('date3')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <table class="table card-table table-vcenter text-nowrap" id="subhendu">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" style="width: 5%">Adh/Free Br<span class="text-danger">*</span></th>
                                    ...
                                    <tbody>
                                        @for ($i = 1; $i < 11; $i++) <tr>
                                            <td>
                                                <input type="text" class="form-control" name="sl_no[]" id="sl_no{{$i}}" value="{{$i}}" />
                                            </td>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="drift[]" id="drift{{$i}}" value="" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="adh[]" id="adh{{$i}}" value="" />
                                            </td>

                                            <input type="hidden" class="form-control" name="addition_test[]" id="addition_test{{$i}}" value="" />
