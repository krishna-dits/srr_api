                        ...
                        <div class="col-md-6 text-right">
                            <div class="d-block">
                                ...
                                @can('Create Is Master')
                                    <td><a href="{{ route('BatchAdd') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add
                                            Batch</a></td>
                                @endcan
                                            ...
                                            <div class="card-options">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" style="">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('BatchEdit', base64_encode($item->id)) }}"><i
                                                            class="fa fa-edit"></i> Edit</a>

                                                    <a class="dropdown-item"
                                                        href="{{ route('BatchDelete', base64_encode($item->id)) }}"><i
