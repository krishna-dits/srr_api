...
@section('content')
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <input type="text"
                                            class="form-control @error('batch_id') is-invalid
                                        @enderror"
                                            name="batch_id" placeholder="Is Name" value="{{ $BatchNumber }}" readonly>
                                        @error('batch_id')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="batch_no" id="batch_no"
                                            value="{{ old('batch_no') }}" placeholder=" Batch No" readonly />
                                        @error('batch_no')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="lot_no" id="lot_no"
                                            value="{{ old('lot_no') }}" placeholder=" Lot No" readonly />
                                        @error('lot_no')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="descriptation" id="descriptation"
                                            value="{{ old('descriptation') }}" placeholder=" Descriptation" readonly />
                                        @error('descriptation')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control select2-show-search select2-hidden-accessible"
                                            tabindex="-1" aria-hidden="true" name="is_name"
                                            onchange="getAllValues(this.value)" id="is_name">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control select2-show-search select2-hidden-accessible"
                                            tabindex="-1" aria-hidden="true" name="shift" id="shift"
                                            onchange="getBatchNo()">
                                            <option value="">Select</option>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="date" class="form-control" name="mill_date"
                                            value="{{ old('mill_date') ?? now()->toDateString() }}" id="mill_date"
                                            placeholder="Enter Mill Date" onchange="getBatchNo()" />
                                        @error('mill_date')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <label class="form-label">Coil Indentification No <span
                                                class="text-danger">*</span></label>
                                        <select class="form-control select2-show-search select2-hidden-accessible"
                                            tabindex="-1" aria-hidden="true" name="coil_no" id="coil_no">
                                            <option value="">Select Coil Indentification</option>
                                            @foreach ($coil_master as $item)
                                                <option value="{{ $item->indentification_no }}">
                                                    {{ $item->indentification_no }}</option>
                                            @endforeach
                                        </select>
                                        @error('coil_no')
                                            <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="hit_no" id="hit_no"
                                            value="{{ old('hit_no') }}" placeholder="Enter Quantity" />
                                        @error('hit_no')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="hit_no1" id="hit_no1"
                                            value="{{ old('hit_no1') }}" placeholder="Enter Quantity" />
                                        @error('hit_no1')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="hit_no2" id="hit_no2"
                                            value="{{ old('hit_no2') }}" placeholder="Enter Quantity" />
                                        @error('hit_no2')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="hit_no3" id="hit_no3"
                                            value="{{ old('hit_no3') }}" placeholder="Enter Quantity" />
                                        @error('hit_no3')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="hit_no4" id="hit_no4"
                                            value="{{ old('hit_no4') }}" placeholder="Enter Quantity" />
                                        @error('hit_no4')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
    ...
    @enderror
     ...
     -->
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control select2-show-search select2-hidden-accessible"
                                            tabindex="-1" aria-hidden="true" name="size" id="sizeDropdown"
                                            onchange="getBatchNo()">
                                            <option value="">Select</option>
                                        </select>
                                        @error('size')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control select2-show-search select2-hidden-accessible"
                                            tabindex="-1" aria-hidden="true" name="thickness" id="thickness"
                                            onchange="getBatchNo()">
                                            <option value="">Select</option>
                                            @foreach ($thickness as $item)
                                                <option value="{{ $item->desire }}">{{ $item->desire }}</option>
                                            @endforeach
                                        </select>
                                        @error('thickness')
                                            <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="quality" id="quality"
                                            value="{{ old('quality') }}" placeholder="Enter Quantity" />
                                        @error('quality')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <label class="form-label">Black & Galvanised <span
                                                class="text-danger">*</span></label>
                                        <select class="form-control select2-show-search select2-hidden-accessible"
                                            tabindex="-1" aria-hidden="true" name="pipe_type" id="pipe_type"
                                            onchange="getDetailsAccordingType(this.value)">
                                            <option value="">Select</option>
                                    ...
                                    <div style="display:none" class="col-md-4" id="galbanaised">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="zn1" id="zn1"
                                                    value="{{ old('zn1') }}" placeholder="Enter Zn 1" />
                                                @error('zn1')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="zn2" id="zn2"
                                                    value="{{ old('zn2') }}" placeholder="Enter Zn 2" />
                                                @error('zn2')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
    ...
    @enderror
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control" name="yst1" id="yst1"
                                            value="{{ old('yst1') }}" placeholder="Enter YST 1" />
                                        @error('yst1')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control" name="yst2" id="yst2"
                                            value="{{ old('yst2') }}" placeholder="Enter Zn 2" />
                                        @error('yst2')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control" name="uts1" id="uts1"
                                            value="{{ old('uts1') }}" placeholder="Enter Uts 1" />
                                        @error('uts1')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="uts2" id="uts2"
                                            value="{{ old('uts2') }}" placeholder="Enter Uts 2" />
                                        @error('uts2')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control" name="elgn1" id="elgn1"
                                            value="{{ old('elgn1') }}" placeholder="Enter ELGN 1st" />
                                        @error('elgn1')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control" name="elgn2" id="elgn2"
                                            value="{{ old('elgn2') }}" placeholder="Enter ELGN 2nd" />
                                        @error('elgn2')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                ...
                success: function(response) {
                    ...
                    $.each(response.thick_values, function(key, value) {
                        if (value.thik_value === 'NA') {
                            ...
                            div_data += `<option value="${value.desire}">${value.desire}</option>`;
                        }
                    });
                    ...
                    if (response.size_list) {
                        ...
                        $.each(response.size_list, function(key, value) {
                            sizeDropdown.append($('<option>', {
                                value: value
                                .desier, // Assuming 'is_size' holds the size information
                                text: value.desier
                            }));
                        });
                    }
